...
{
    public interface IWampSessionManagementServiceProxy
    {
        /// <summary>
        ...
        Task KillBySessionIdAsync(long session, string reason = WampErrors.CloseNormal, string message = null);
        ...
        Task<int> KillByAuthIdAsync(string authId, string reason = WampErrors.CloseNormal, string message = null);
        ...
        Task<int> KillByAuthRoleAsync(string authRole, string reason = WampErrors.CloseNormal, string message = null);
        ...
        Task<int> KillAllAsync(string reason = WampErrors.CloseNormal, string message = null);
    }
}